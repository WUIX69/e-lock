        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <div className="hover:bg-accent-green/10 flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border bg-card p-6 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedFiles.map((file) => {
                    ...
                    const isImg = /\.(jpg|jpeg|png|gif|webp|bmp|svg)$/i.test(
                      file.name
                    )
                    return (
                      <div
