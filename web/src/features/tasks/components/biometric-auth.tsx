...
export const BiometricAuth = () => {
  return (
    <div className="flex flex-1 flex-col items-center justify-center p-4">
      <div className="relative mb-4 h-32 w-32 group cursor-pointer">
        <div className="absolute inset-0 animate-pulse rounded-full bg-primary/10 border border-primary/20" />
        <div className="absolute inset-4 flex items-center justify-center rounded-full bg-card shadow-lg text-primary">
