...
export function UserTelemetryChart({ data }: { data: TelemetrySample[] }) {
  return (
    <section className="col-span-12 lg:col-span-7 rounded-3xl border border-border bg-card p-8 shadow-sm">
      ...
      <div className="h-64 w-full">
        <ChartContainer config={chartConfig} className="h-full w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <defs>
                <linearGradient id="fillVoltageUser" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-voltage)" stopOpacity={0.4} />
                  <stop offset="95%" stopColor="var(--color-voltage)" stopOpacity={0} />
                </linearGradient>
              </defs>
